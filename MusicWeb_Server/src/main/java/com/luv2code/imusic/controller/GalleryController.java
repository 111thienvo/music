...
public class GalleryController {
    ...
    @GetMapping("findall")
    public ResponseEntity<Iterable<Gallery>> findAll() {
    	Iterable<Gallery> findAllGallery = galleryService.findAll();
        return new ResponseEntity<Iterable<Gallery>>(findAllGallery,HttpStatus.OK);
    }
}
