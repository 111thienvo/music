(function ($) {
    ...
    // ******************************
    if ($.fn.owlCarousel) {
        var latestNewsSlide = $('.tbdv-latest-news-slide');
    ...
    // *******************************
    if ($.fn.imagesLoaded) {
        $('.tbdv-blog-masonary').imagesLoaded(function () {
            // init Isotope
            var $grid = $('.tbdv-blog-masonary').isotope({
                itemSelector: '.tbdv-blog-masonary-item',
                percentPosition: true,
                masonry: {
                    columnWidth: '.tbdv-blog-masonary-item'
                }
            });
        });
    }
