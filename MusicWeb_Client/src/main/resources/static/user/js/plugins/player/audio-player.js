...
/*function reply_click() {
 ...
 $('.button').click(function(){
        	  var images = $('.img1 audio source').prop('src');
...
$(function() {
	...
	/*	var f1 = function reply_click2(){
			var  getIdSong1 = event.srcElement.id;
    		return getIdSong1;
		}
		var result=f1();*/
		var a = function reply_click(){
		/*var  getIdSong1 = event.srcElement.id;*/
		alert("Button clicked, id "+event.srcElement.id+", text"+this.innerHTML);
		
		}
		
		
		var nameSong = $('#nameSong').text();
		
		var result = "123";
		var nameArtist = $('#nameArist').text();
		var nameImage = $("#"+result).prop('src');
		var nameMp3 = $("#nameMp3").prop('src');
