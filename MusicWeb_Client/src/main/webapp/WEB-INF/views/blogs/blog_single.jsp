...
<mt:layout_user title="Blog Single">
					...
					<div class="col-lg-9 col-md-9">
						<div class="ms_blog_single">
							<div class="blog_single_img">
								<img src="${pageContext.request.contextPath }/resources/user/images/blog/blog_single.jpg" alt="" class="img-fluid">
							</div>
									...
									<li>
										<div class="ms_comment_section">
											<div class="comment_img">
												<img src="${pageContext.request.contextPath }/resources/user/images/blog/author.jpg" alt="">
											</div>
						...
						<div class="ms_sidebar">
						   ...
						   <div class="widget widget_recent_entries">
								...
								<ul>
									...
									<li>
										<div class="recent_cmnt_img">
											<img src="${pageContext.request.contextPath }/resources/user/images/blog/fp_img1.jpg" alt="">
										</div>
										<div class="recent_cmnt_data">
									...
									<li>
										<div class="recent_cmnt_img">
											<img src="${pageContext.request.contextPath }/resources/user/images/blog/fp_img2.jpg" alt="">
										</div>
										<div class="recent_cmnt_data">
