                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="ms_genres_box">
                                    <img src="${pageContext.request.contextPath }/resources/user/images/genrs/img7.jpg" alt="" class="img-fluid" />
                                    <div class="ms_main_overlay">
                                        <div class="ms_box_overlay"></div>
                                        <div class="ms_play_icon">
                                            <img src="${pageContext.request.contextPath }/resources/user/images/svg/play.svg" alt="">
                            ...
                            <div class="col-lg-8">
                                <div class="ms_genres_box">
                                    <img src="${pageContext.request.contextPath }/resources/user/images/genrs/img8.jpg" alt="" class="img-fluid" />
                                    <div class="ms_main_overlay">
                                        <div class="ms_box_overlay"></div>
                                        <div class="ms_play_icon">
                                            <img src="${pageContext.request.contextPath }/resources/user/images/svg/play.svg" alt="">
                            ...
                            <div class="col-lg-4">
                                <div class="ms_genres_box">
                                    <img src="${pageContext.request.contextPath }/resources/user/images/genrs/img9.jpg" alt="" class="img-fluid" />
                                    <div class="ms_main_overlay">
                                        <div class="ms_box_overlay"></div>
                                        <div class="ms_play_icon">
                                            <img src="${pageContext.request.contextPath }/resources/user/images/svg/play.svg" alt="">
                            ...
                            <div class="col-lg-4">
                                <div class="ms_genres_box">
                                    <img src="${pageContext.request.contextPath }/resources/user/images/genrs/img10.jpg" alt="" class="img-fluid" />
                                    <div class="ms_main_overlay">
                                        <div class="ms_box_overlay"></div>
                                        <div class="ms_play_icon">
                                            <img src="${pageContext.request.contextPath }/resources/user/images/svg/play.svg" alt="">
                            ...
                            <div class="col-lg-4">
                                <div class="ms_genres_box">
                                    <img src="${pageContext.request.contextPath }/resources/user/images/genrs/img11.jpg" alt="" class="img-fluid" />
                                    <div class="ms_main_overlay">
                                        <div class="ms_box_overlay"></div>
                                        <div class="ms_play_icon">
                                            <img src="${pageContext.request.contextPath }/resources/user/images/svg/play.svg" alt="">
                    ...
                    <div class="col-lg-2">
                        <div class="ms_genres_box">
                            <img src="${pageContext.request.contextPath }/resources/user/images/genrs/img12.jpg" alt="" class="img-fluid" />
                            <div class="ms_main_overlay">
                                <div class="ms_box_overlay"></div>
                                <div class="ms_play_icon">
                                    <img src="${pageContext.request.contextPath }/resources/user/images/svg/play.svg" alt="">
                    ...
                    <div class="col-lg-4">
                        <div class="ms_genres_box">
                            <img src="${pageContext.request.contextPath }/resources/user/images/genrs/img13.jpg" alt="" class="img-fluid" />
                            <div class="ms_main_overlay">
                                <div class="ms_box_overlay"></div>
                                <div class="ms_play_icon">
                                    <img src="${pageContext.request.contextPath }/resources/user/images/svg/play.svg" alt="">
