...
<!----Footer Start---->
        <div class="ms_footer_wrapper">
            <div class="ms_footer_logo">
                <a href="${pageContext.request.contextPath }"><img src="${pageContext.request.contextPath }/resources/user/images/open_logo.png" alt=""></a>
            </div>
            <div class="ms_footer_inner">
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer_box">
                            <h1 class="footer_title">the music station</h1>
                            <p>ABCDEF.</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6">
                            ...
                            <ul class="foo_con_info">
                                <li>
                                    ...
                                    <div class="foo_con_data">
                                        ...
                                        <span>(+84) 12345678, (+84) 87654321</span>
                                    </div>
                                </li>
                                <li>
                                    <div class="foo_con_icon">
                                    ...
                                    <div class="foo_con_data">
                                        ...
                                        <span><a href="#">abc@mail.com </a>, <a href="#">def@mail.com</a></span>
                                    </div>
                                </li>
                                <li>
                                    <div class="foo_con_icon">
            ...
            <div class="col-lg-12">
                <div class="ms_copyright">
                    <div class="footer_border"></div>
               		 <p>Copyright &copy; 2022 <a href="#">The Music Online</a>. All Rights Reserved.</p> 
                </div>
            </div>
        </div>