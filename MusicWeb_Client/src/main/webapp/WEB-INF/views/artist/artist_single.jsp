...
<mt:layout_user title="Artist Single">
        ...
        <div class="ms_album_single_wrapper ms_artist_single">
            <div class="album_single_data">
                <div class="album_single_img">
                    <img src="${pageContext.request.contextPath }/resources/user/images/featured/song1.jpg" alt="" class="img-fluid">
                </div>
                <div class="album_single_text">
                    ...
                    <div class="album_btn">
                        <a href="#" class="ms_btn play_btn"><span class="play_all"><img src="${pageContext.request.contextPath }/resources/user/images/svg/play_all.svg" alt="">Play All</span><span class="pause_all"><img src="${pageContext.request.contextPath }/resources/user/images/svg/pause_all.svg" alt="">Pause</span></a>
                        <a href="#" class="ms_btn"><span class="play_all"><img src="${pageContext.request.contextPath }/resources/user/images/svg/add_q.svg" alt="">Add To Queue</span></a>
                    </div>
                </div>
                <div class="album_more_optn ms_more_icon">
                    <span><img src="${pageContext.request.contextPath }/resources/user/images/svg/more.svg" alt=""></span>
                </div>
