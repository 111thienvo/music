					...
					<div class="album_list_wrapper">
						...
						<ul>
							...
							<li class="text-center"><a href="#"><span class="ms_close">
									<img src="${pageContext.request.contextPath }/resources/user/images/svg/close.svg" alt=""></span></a></li>
						</ul>
						<ul>
                ...
                <div class="ms_radio_slider swiper-container">
                    <div class="swiper-wrapper">
                        ...
                        <div class="swiper-slide">
                            <div class="ms_rcnt_box">
                                <div class="ms_rcnt_box_img">
                                    <img src="${pageContext.request.contextPath }/resources/user/images/artist/artist2.jpg" alt="">
                                    <div class="ms_main_overlay">
                                        <div class="ms_box_overlay"></div>
                                        <div class="ms_more_icon">
                                            <img src="${pageContext.request.contextPath }/resources/user/images/svg/more.svg" alt="">
